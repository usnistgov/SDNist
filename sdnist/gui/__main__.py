...
def sdnist_gui():
    ...
    # Check and download target data if not present
    ...
    logo_path = Path(gui_pkg_path, 'res', 'sdnist_logo.png')
    ...
    while is_running:
        ...
        screen.blit(fps_text, (10, screen.get_height() - text_rect.height - 10))
