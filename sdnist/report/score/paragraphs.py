...
k_marg_all_puma_para = (
    "Different PUMA have different subpopulations and "
...
corr_para = (
    "A key goal of deidentified data is to preserve the feature correlations from the target "
...
kend_corr_para = (
    "This chart shows pairwise correlations using a somewhat different "
...
propensity_para = (
    "Can a decision tree classifier tell the difference between the target data and the deidentified data? "
...
unique_exact_match_para_1 = (
    "Unique Exact Match (UEM) is a simple privacy metric that counts the "
...
unique_exact_match_para_2 = (
    "Below we also include an estimate of the feature space size. The feature "
...
unique_exact_match_para_3 = (
    "As we add features to the feature set, we increase the size of the "
...
unique_exact_match_para_4 = (
    "The Target Data Properties below provides an estimate of the feature "
