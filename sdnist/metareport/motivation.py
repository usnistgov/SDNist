...
def add_motivation(meta_report_old_ui_data: ReportUIData, config_name: str):
    m_ui_data = meta_report_old_ui_data
    attachments = []
    motivation_paras = []
    if config_name == 'e_10':
        from sdnist.meta_report_old.configs import \
    ...
    #         lostinthenoise_motivation_paras as motivation_paras
        ...
        from sdnist.meta_report_old.configs.libraries import \
        ...
        from sdnist.meta_report_old.configs.libraries import \
            anonossdk_motivation_paras as motivation_paras
    elif config_name == 'ydata':
        from sdnist.meta_report_old.configs.libraries import \
            ydata_motivation_paras as motivation_paras
    elif config_name == 'aim':
        from sdnist.meta_report_old.configs.libraries import \
            aim_motivation_paras as motivation_paras
    elif config_name == 'ydata_synthetic':
        from sdnist.meta_report_old.configs.libraries import \
            ydata_synth_motivation_paras as motivation_paras
    elif config_name == 'smote':
        from sdnist.meta_report_old.configs.libraries import \
            smote_motivation_paras as motivation_paras
    elif config_name == 'aim_msp':
        from sdnist.meta_report_old.configs.libraries import \
            aim_mst_motivation_paras as motivation_paras
